...
public class AddProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  progressBar=(ProgressBar)findViewById(R.id.progressbar);
        ...
        adapter = new SelectedviewAdapter(selectedpicsList, AddProduct.this,1);
...
*/
        ...
        uploadproduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedpicsList != null && selectedpicsList.size() > 0) {
                        ...
                        if (!selectedRecordtype.isEmpty()) {
                            ...
                            if (!proCost.getText().toString().isEmpty()) {
                             ...
                             /*       fileReference.putFile(Uri.parse(picLocalpath)).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                Toast.makeText(AddProduct.this, "please enter cost", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                    ...
                    Toast.makeText(AddProduct.this, "Please select images", Toast.LENGTH_SHORT).show();
                }
            }
        });
        selectcolors.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialog_primary = new Dialog(AddProduct.this, android.R.style.Theme_Light_NoTitleBar);
                ...
                colorsAdapter=new SelectColorsAdapter(colorsPojoArrayList,AddProduct.this,1);
    ...
    private void Addmetadata() {
        ...
        Toast.makeText(AddProduct.this, "Product successfully uploaded", Toast.LENGTH_SHORT).show();
        imageUrls.clear();
        finish();
    }
...
*//*
    ...
    private void loadSpinner() {
        ...
        category.add("Other");
        rectypeadp = new ArrayAdapter<String>(AddProduct.this, android.R.layout.simple_spinner_dropdown_item, category);
